...
struct AddFamilyMemberView: View {
    ...
    private func addMember() async {
        ...
        do {
            let _: CreateFamilyMemberResponse = try await APIClient.shared.request(.createFamilyCircleMember(circleId: circleId), body: request)
...
struct MemberImagePicker: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, PHPickerViewControllerDelegate {
        let parent: MemberImagePicker

        init(_ parent: MemberImagePicker) {
            self.parent = parent
        }
...
#Preview {
    AddFamilyMemberView(circleId: 1, circleName: "Test Family")
}
